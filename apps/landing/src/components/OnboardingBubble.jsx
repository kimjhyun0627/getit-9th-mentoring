 ...
 * - 우상단 다크 토글 옆 mini hint arrow 로 토글 위치 안내
...
export const OnboardingBubble = () => {
  ...
  return (
    <div
      ...
      className="fixed right-4 top-20 z-40 w-[min(20rem,calc(100vw-2rem))] rounded-lg border border-cyan-700 bg-white/95 p-4 font-mono text-[12px] leading-relaxed text-zinc-700 shadow-lg backdrop-blur dark:border-cyan-neon dark:bg-ink-900/95 dark:text-zinc-200 dark:shadow-[0_0_0_1px_rgba(34,211,238,0.4),0_0_28px_-4px_rgba(34,211,238,0.55)]"
    >
      <div
        aria-hidden="true"
        data-testid="onboarding-hint-arrow"
        className="absolute -top-2 right-10 h-2 w-2 rotate-45 border-l border-t border-cyan-700 bg-white/95 dark:border-cyan-neon dark:bg-ink-900/95"
      />
      <p
