 ...
 *
 * #446 — `role='dialog'` + `aria-modal='false'` 조합은 WAI-ARIA 위반.
 *   focus trap / Esc 닫기 / inert background 없는 비-블로킹 토스트.
 *   → `role='status'` + `aria-live='polite'` 로 토스트 의도 명확화.
 *
