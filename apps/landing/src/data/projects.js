 ...
 * @property {string} slug - 영문 슬러그 (UPPERCASE 카드 헤더용 + ProjectIcons 매핑 키)
 ...
 *
 * #434 — emoji 필드 폐기. ProjectCard 는 slug 로 ProjectIcons 매핑 (mono SVG glyph).
 *   액센트 currentColor 상속으로 cyan/magenta/lime/amber 통일.
 *
 * @type {Project[]}
 */
