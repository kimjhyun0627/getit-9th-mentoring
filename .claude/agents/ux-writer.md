...
- Phase 3.6: UX writer 라운드 — 5 프로젝트 카피 검토 (5 agent 병렬, issue만)
- Phase 3.7: FE resolve 라운드 — UX issue 선정 + FE agent 디스패치 (issue 단위 PR)

## 우선순위 (Phase별)

- **Phase 3.6** (Phase 3.5 다크 fix 직후): 5 프로젝트 카피 검토 라운드 — 각 프로젝트 1 agent, 한 PR per 프로젝트
...
- **FE Engineer**: FE는 컴포넌트/인터랙션, ux-writer는 그 안의 텍스트. FE가 임시 텍스트 박고 → ux-writer가 라운드별 검토 + 수정 PR.
